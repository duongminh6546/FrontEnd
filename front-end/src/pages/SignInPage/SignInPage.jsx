...
const SignInPage = () => {
  ...
  return (
    <div style={{display: 'flex', alignItems: 'center',justifyContent: 'center',background: 'rgba(0,0,0,0.53)',height: '100vh'}}>
        <div style={{width: '800px',height: '455px', borderRadius: '6px',background: '#fff',display: 'flex'}}>
      ...
      <WrapperContainerRight>
        ...
        <h4>Mua sắm tại PHUDUONG</h4>
        <h5>Nơi mua sắm ưu đãi mỗi ngày</h5>
      </WrapperContainerRight>
    </div>
    </div>
  )
