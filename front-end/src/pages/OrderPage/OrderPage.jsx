        ...
        <div style={{ display: 'flex', justifyContent: 'center'}}>
          <WrapperLeft>
            ...
            <WrapperStyleHeaderDilivery>
              <StepComponent items={itemsDelivery} current={diliveryPriceMemo === 10000 // Nếu diliveryPriceMemo === 10000
                ? 2 : diliveryPriceMemo === 20000 ? 1  // Chọn mục có index 2 trong mảng items và nếu  === 20000
