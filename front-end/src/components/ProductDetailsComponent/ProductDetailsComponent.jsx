...
import imageProductSmall from '../../assets/images/iphone12small.webp'
...
const ProductDetailsComponent = ({idProduct}) => {
    ...
    useEffect(() => { // khi click vào page detail nó sẽ chạy đến thằng này trước
        initFacebookSDK()
    }, [])
    ...
    return (
        <Loading isPending={isLoading}>
            <Row style={{ padding: '16px', background: '#fff', borderRadius: '4px', height:'100%' }}>
                ...
                <Col span={14} style={{ paddingLeft: '10px' }}>
                    ...
                    <div style={{ display: 'flex', aliggItems: 'center', gap: '12px' }}>
                        <div>
                            ...
                            ></ButtonComponent>
                            {errorLimitOrder && <div style={{color: 'red'}}>Rất tiếc sản phẩm đã hết hàng !</div>}
                        </div>
                        <ButtonComponent
                            size={40}
                            styleButton={{
                ...
                <CommentComponent dataHref={"https://developers.facebook.com/docs/plugins/comments#configurator"} width ="1270"></CommentComponent>
                {/* <CommentComponent 
                    dataHref={process.env.REACT_APP_IS_LOCAL 
