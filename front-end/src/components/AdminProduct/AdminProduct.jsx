...
const AdminProduct = () => {
  ...
  const { data: dataUpdate,isPending : isPendingUpdated, isSuccess: isSuccessUpdated,isError: isErrorUpdated} = mutationUpdate
  const { data: dataDeleted,isPending : isPendingDeleted, isSuccess: isSuccessDeleted,isError: isErrorDeleted} = mutationDeleted
  const { data: dataDeletedMany, isLoading: isPendingDeletedMany, isSuccess: isSuccessDelectedMany, isError: isErrorDeletedMany } = mutationDeletedMany
  const queryProduct = useQuery({queryKey: ['products'],queryFn: getAllProducts})
  const typeProduct = useQuery({ queryKey: ['type-product'], queryFn: fetchAllTypeProduct }) // coi lại query có nhận ko nè
        ...
        <Loading isPending ={isPending}>
          ...
          >
            ...
            <Form.Item
              label="Count inStock"
              name="countInStock"
              rules={[{ required: true, message: 'Please input your count isStock!' }]}
            >
            ...
            >
              <WrapperUploadFile on onChange={handleOnchangeAvatar} maxCount={1}>
 ...
 >
              ...
              rules={[{ required: true, message: 'Please input your count image!' }]}
            >
              <WrapperUploadFile on onChange={handleOnchangeAvatarDetails} maxCount={1}>
                <Button>Select File</Button>
