...
const AdminUser = () => {
    ...
    const [form] = Form.useForm();    //lỗi ở console nằm ở đây ! 
  ...
  const columns = [
    ...
    },
    {
      title: 'Address',
      dataIndex: 'address',
      sorter: (a, b) => a.address.length || 0 - b.address.length,
      ...
      <Loading isPending ={isPendingUpdate || isPendingUpdated}>
          ...
          >
            ...
            >
              ...
              label="Avatar"
              name="avatar"
              rules={[{ required: true, message: 'Please input your your avatar!' }]}
            >
